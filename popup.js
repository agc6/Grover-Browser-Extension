...
function groverRequest() {
    ...
    //this is also a placeholder. we need a way to look at the response we get back in the sendPost function and extract the groverprob number from it.
    //once we have the groverprob number, it should be a pretty simple if statement; if(groverprob < 0.5) change the innerHTML to 'Human Written', else change it to 
    //'Machine Written', something like that
