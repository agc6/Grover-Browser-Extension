...
async function getArticleText() {
    ...
    //        console.log(response);
                const articleText = await navigator.clipboard.readText();
...
async function queryAPI(articleText) {
    ...
    //console.log('Request Body before:', requestBodyJSON);
    const requestBody = JSON.stringify(requestBodyJSON);
	//console.log('Request Body stringified:', requestBodyJSON);
    // Send POST request to API
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.open("POST", 'https://discriminate.grover.allenai.org/api/disc', true);
